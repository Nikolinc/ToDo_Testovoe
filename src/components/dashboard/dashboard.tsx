...
export default function Dashboard() {
  ...
  return <div className=" component dashboard flex-center" onClick={() => setProgress(progress + 1)}>
    <svg className="flex-center svg-progress-bar" width='100%' height='100%'>
      <circle ref={circle} className="progress-bar flex-center" strokeWidth="2rem" cx="160" cy="150" r="100" fill="transparent" />
      <text x="115" y="170" fill="var(--text)">{progress}%</text>
    </svg>
